                        ...
                        <div class="sidebar-single-widget" >
                            ...
                            <div class="sidebar-content">
                                <ul class="sidebar-menu">
                                    <li>
                                        <ul class="sidebar-menu-collapse">
                                           ...
                                           <li class="sidebar-menu-collapse-list">
                                               <div class="accordion">
                                                   <a href="#" class="accordion-title collapsed" data-bs-toggle="collapse" data-bs-target="#men-fashion" aria-expanded="false"> <i class="ion-ios-arrow-right"></i></a>
                                   ...
                                   <li ><a href="{{ route('catalog', $cata->id) }}">{{$cata->name}}</a></li>  
                                   @endforeach 
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-4 col-sm-6 col-12">
                                                    ...
                                                    <div class="product-default-single-item product-color--golden" data-aos="fade-up"  data-aos-delay="0">
                                                        <div class="image-box">
                                                            <a href="{{ route('detail', ['id' => $pro->id]) }}" class="image-link">
                                                                <img src="{{ asset('images/product/default/home-1/' . $pro->image) }}" alt="">
