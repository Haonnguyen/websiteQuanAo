                ...
                <div class="col-lg-3 col-sm-6 mb-6">
                    ...
                    <div class="footer-widget-single-item footer-widget-color--golden" data-aos="fade-up"  data-aos-delay="600">
                        ...
                        <div class="footer-about">
                            <p>Chúng tôi là một nhóm gồm các nhà thiết kế và phát triển tạo ra Magento, Prestashop, Opencart chất lượng cao.</p>
                            
                            <address class="address">
                                <span>Địa chỉ: Tân thới nhất, Quận 12, TP.HCM</span> 
                                <span>Email: haontps33572@gmail.com</span>    
                            </address>
                        </div>
                    </div>
                    <!-- End Footer Single Item -->
                ...
                <div class="row mb-n6">
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-6">
                        <div class="footer-social" data-aos="fade-up"  data-aos-delay="0">
                            <h4 class="title">THEO CHÚNG TÔI</h4>
                    ...
                    <div class="col-xl-7 col-lg-6 col-md-6 mb-6">
                        <div class="footer-newsletter" data-aos="fade-up"  data-aos-delay="200">
                            <h4 class="title">ĐỪNG BỎ LỠ MỚI NHẤT</h4>
                            <div class="form-newsletter">
                                <form action="#" method="post">
                                    <div class="form-fild-newsletter-single-item input-color--golden">
                                        <input type="email" placeholder="Địa chỉ mail của bạn..." required>
                ...
                <div class="row justify-content-between align-items-center align-items-center flex-column flex-md-row mb-n6">
                    <div class="col-auto mb-6">
                        <div class="footer-copyright" >
                            <p> BẢN QUYỀN &copy; <a href="https://hasthemes.com/" target="_blank">NTH</a>. ĐÃ ĐĂNG KÝ</p>
                        </div>
                    </div>
                    <div class="col-auto mb-6">
